...
namespace SlmpProtocol {
    ...
    public class DeviceMethods {
        ...
        public static ushort GetSubcommand(Device device) {
            ...
            {
                case DeviceType.Bit: return 0x0001;
                case DeviceType.Word: return 0x0000;
                default: throw new ArgumentException("invalid device type provided");
            }
        ...
        public static DeviceType GetDeviceType(Device device) {
            switch (device)
            {
                case Device.D: return DeviceType.Word;
                case Device.W: return DeviceType.Word;
                case Device.R: return DeviceType.Word;
                case Device.ZR: return DeviceType.Word;
                case Device.SD: return DeviceType.Word;
                case Device.X: return DeviceType.Bit;
                case Device.Y: return DeviceType.Bit;
                case Device.M: return DeviceType.Bit;
                case Device.B: return DeviceType.Bit;
                case Device.SM: return DeviceType.Bit;
                default: throw new ArgumentException("invalid device");
            }
